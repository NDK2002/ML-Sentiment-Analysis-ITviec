...
> "Dạ em xin kính chào Thầy Cáp Phạm Đình Thăng cùng toàn thể các bạn!
> 
> Nhóm chúng em gồm 4 thành viên là sinh viên năm nhất đang theo học môn Máy học. Với đồ án này, nhóm em chọn bài toán: **Phân tích cảm xúc các đánh giá công ty trên nền tảng ITviec**.
> 
> Từ 8.417 dữ liệu thô ban đầu, sau khi loại bỏ trùng lặp, nhóm dùng **8.414 review** để xây dựng mô hình phân loại 3 lớp: Tích cực, Trung tính và Tiêu cực. Hôm nay, nhóm em xin phép báo cáo về quy trình thực nghiệm, kết quả đạt được và những điểm nhóm còn cần cải thiện ạ."
...
> "Quy trình thực nghiệm của nhóm em đi qua 5 bước rõ ràng:
> 
...
> 
> Tiếp theo, nhóm thử nghiệm 5 mô hình trên tập Development qua phương pháp 5-Fold Cross Validation.
> 
> Đặc biệt, khi kiểm tra các câu ngắn, nhóm phát hiện bộ tiền xử lý cũ vô tình xóa mất một số từ mang cảm xúc. Nhóm đã kịp thời tinh chỉnh lại và huấn luyện phiên bản `retrained_v2` với mô hình Logistic Regression kết hợp SMOTE, đạt **Macro F1 0,5764 trên cùng tập Final Test cũ** để làm đối chứng minh bạch ạ."
...
> 
> Tuy nhiên, tương quan không đồng nghĩa với quan hệ nhân quả. Khi người dùng nhập một review mới ngoài thực tế, họ thường không chấm các điểm thành phần này. Vì vậy, pipeline phân loại của nhóm chỉ dựa hoàn toàn trên văn bản review ạ."
...
> "Ở lần thử nghiệm ban đầu, Logistic Regression và Linear SVM bám đuổi rất sát nhau với Macro F1 lần lượt là 0,5727 và 0,5724 — chênh lệch chỉ 0,0003. Nhóm chọn Logistic Regression vì mô hình này trả về xác suất mềm rất trực quan cho ứng dụng demo.
> 
> Sau khi sửa tiền xử lý, nhóm chạy một phép 5-Fold CV độc lập trên tập Development để kiểm chứng lại. Kết quả cho thấy Macro F1 tăng từ 0,5708 lên **0,5815**.
> 
> Nhóm em xin nhấn mạnh: đây là phép CV riêng rẽ để chọn ra bản sửa tốt nhất, chứ nhóm không so sánh trực tiếp một cách tùy tiện với các bảng điểm cũ ạ."
...
> "Để hiểu tại sao mô hình còn đoán sai 432 mẫu, hệ thống của nhóm đã tự động gom nhóm phân tích 15 lỗi minh họa:
> 
...
> 
> Nhóm em xin lưu ý: biểu đồ này chỉ mang tính mô tả trên mẫu dữ liệu thu thập được từ ITviec, nhóm không xem đây là thước đo xếp hạng doanh nghiệp ngoài đời thực ạ."
...
> "Trên màn hình là ví dụ câu review: *'Lương thấp, quản lý thiếu minh bạch và thường xuyên phải OT không lương'*. Bản sửa mới nhất nhận diện chính xác nhãn Tiêu cực với xác suất lên tới **99,0%**.
> 
...
> "Qua đồ án môn học này, nhóm sinh viên năm nhất chúng em đã tự tay xây dựng trọn vẹn một pipeline học máy hoàn chỉnh từ dữ liệu thô đến mô hình hóa và triển khai giao diện.
> 
...
> "Tóm lại, đồ án đã mang lại cho nhóm em những trải nghiệm thực tế quý báu về xử lý văn bản tiếng Việt và tư duy thực nghiệm cẩn trọng trong Machine Learning.
> 
...
> 
> Phần trình bày slide của em xin được tạm dừng tại đây. Tiếp theo, em xin trân trọng kính mời bạn **Nguyễn Duy Khang** đại diện nhóm tiến hành phần Live Demo ứng dụng ạ!"
